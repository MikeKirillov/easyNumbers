...
public class Builder {
    ...
    /*Класс, объекты которого будут создаваться при помощи паттерна Builder. Состоит из полей,
        сеттеров и переопределенного метода toString(). На схеме паттерна обозначен как Product*/
    static class Salad {
    ...
    //На схеме обозначен как Builder.
