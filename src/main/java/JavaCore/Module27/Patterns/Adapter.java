...
работать вместе за счет преобразования интерфейса одного класса в интерфейс другого класса*/
}
...
//  Интерфейс старого плеера, методы которого использует клиентская часть. Позволяют начать и остановить воспроизведение.
...
//  Класс адаптер, реализованный через наследование. Чтобы адаптер работал, нужно унаследоваться от
//  класса NewPlayer и реализовать интерфейс OldPlayerInterface.
