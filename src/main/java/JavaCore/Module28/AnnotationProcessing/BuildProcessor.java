package JavaCore.Module28.AnnotationProcessing;
...
public class BuildProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        // В методе process() мы получаем сеттеры, которые отмечены аннотацией @BuilderField,
        // и создаем класс Builder, используя имена сеттеров
